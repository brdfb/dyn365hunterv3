...
class AlertConfigCreate(BaseModel):
    ...
    alert_type: str = Field(..., description="Alert type: mx_changed, dmarc_added, expire_soon, score_changed")
    notification_method: str = Field(..., description="Notification method: email, webhook, slack")
    enabled: bool = Field(True, description="Whether alert is enabled")
    frequency: str = Field("immediate", description="Frequency: immediate, daily_digest")
