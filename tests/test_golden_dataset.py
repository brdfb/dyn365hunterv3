...
class TestGoldenDataset:
    ...
    def test_golden_dataset_priority_ordering(self):
        ...
        migration_high = [tc for tc in GOLDEN_DATASET 
        ...
        existing = [tc for tc in GOLDEN_DATASET 
                   if tc["expected"]["segment"] == "Existing"]
