...
class TestProcessPendingAlerts:
    ...
    @pytest.mark.asyncio
    async def test_process_pending_alerts_no_config(self, db: Session, test_company, test_alert):
    ...
    @pytest.mark.asyncio
    async def test_process_pending_alerts_webhook_success(self, db: Session, test_company, test_alert):
    ...
    @pytest.mark.asyncio
    async def test_process_pending_alerts_webhook_failure(self, db: Session, test_company, test_alert):
    ...
    @pytest.mark.asyncio
    async def test_process_pending_alerts_email_success(self, db: Session, test_company, test_alert):
    ...
    @pytest.mark.asyncio
    async def test_process_pending_alerts_email_failure(self, db: Session, test_company, test_alert):
    ...
    @pytest.mark.asyncio
    async def test_process_pending_alerts_disabled_config(self, db: Session, test_company, test_alert):
    ...
    @pytest.mark.asyncio
    async def test_process_pending_alerts_multiple_configs(self, db: Session, test_company, test_alert):
    ...
    @pytest.mark.asyncio
    async def test_process_pending_alerts_multiple_alerts(self, db: Session, test_company):
