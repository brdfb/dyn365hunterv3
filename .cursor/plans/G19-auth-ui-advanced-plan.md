...
- [ ] Azure AD app registration
- [ ] Environment variables (`HUNTER_AZURE_CLIENT_ID`, `HUNTER_AZURE_CLIENT_SECRET`, `HUNTER_AZURE_TENANT_ID`)
- [ ] Redirect URI configuration

#### Day 3-4: OAuth 2.0 Flow
- [ ] `app/core/auth.py` - OAuth 2.0 client
...
- [ ] Users table migration (`app/db/migrations/g19_users.sql`)
- [ ] Favorites migration (session-based → user-based)
- [ ] Update `app/db/models.py` (User model)

#### Day 6-7: Testing
- [ ] Unit tests (auth flow)
- [ ] Integration tests (end-to-end OAuth flow)
- [ ] Manual testing (Azure AD login)
...
- [ ] Frontend: Priority badge component
- [ ] Frontend: Score explanation tooltip/modal
- [ ] Backend: Score breakdown endpoint (`GET /leads/{domain}/score-breakdown`)
...
- [ ] Backend: KPI endpoint (`GET /dashboard/kpis`)
- [ ] Backend: Charts data endpoint (`GET /dashboard/charts`)
- [ ] Backend: Recent activity endpoint (`GET /dashboard/activity`)
- [ ] Frontend: KPI cards component
- [ ] Frontend: Charts component (Chart.js or similar)
- [ ] Frontend: Recent activity component
